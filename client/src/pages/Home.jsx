  ...
  return (
    ...
    >
      ...
      <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 w-full max-w-4xl text-center z-10">
        <div className="bg-gray-900 dark:bg-white/10 p-4 rounded-xl backdrop-blur-md">
      ...
      <motion.div className="max-w-4xl mt-20 z-10">
        ...
        <div className="grid md:grid-cols-4 gap-4 text-center">
          {["Register", "Match", "Chat", "Review"].map((step, idx) => (
            <motion.div
              key={step}
              className="bg-gray-900 dark:bg-white/10 p-4 rounded-xl hover:scale-105 transition-all backdrop-blur-md"
      ...
      <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mt-20 w-full max-w-5xl z-10">
        {[
          ...
          <motion.div
            key={idx}
            className="bg-gray-900 dark:bg-white/10 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: idx * 0.2 }}
            viewport={{ once: true }}
      ...
      <motion.div className="max-w-5xl mt-20 w-full z-10">
        ...
        >
          {reviews.map((r, i) => (
            <div key={i} className="p-4 bg-gray-900 dark:bg-white/10 m-2 rounded-xl backdrop-blur-md">
