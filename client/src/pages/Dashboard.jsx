  ...
  return (
    <div className="relative min-h-screen mt-14 text-white p-6 overflow-hidden bg-[#0d1117]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        {/* Welcome Header */}
        <motion.h1
          className="text-3xl font-bold mb-6 flex items-center flex-wrap gap-3"
        ...
        >
          ...
          {renderStars()}
          {matchCount > 0 && (
            <span className="ml-auto bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 text-sm px-4 py-1.5 rounded-full font-semibold">
        ...
        <Matches userId={user.id} token={localStorage.getItem("token")} onMatchesLoad={setMatchCount} />
