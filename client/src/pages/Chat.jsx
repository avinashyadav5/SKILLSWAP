  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1b2845] to-[#000f89] text-white">
      ...
      <div className="w-full max-w-2xl mx-auto sm:px-4 px-2 py-16">
        ...
        {/* CHAT BOX */}
        <div ref={chatContainerRef} className="h-96 sm:h-[28rem] overflow-y-auto bg-gray-900 dark:bg-white/10 backdrop-blur-md p-3 sm:p-4 rounded-xl border border-white/20 mb-4">
        ...
        {/* INPUT BAR */}
        <div className="flex flex-wrap gap-2 items-center w-full mb-4 bg-gray-900 dark:bg-white/10 p-2 rounded-lg relative">
          <button
            onClick={requestCall}
          ...
          <button
            ...
            className="text-xl bg-gray-900 dark:bg-white/20 p-2 rounded-lg"
          >
            😀
          </button>
            ...
            <div className="mt-3 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full bg-gray-900 dark:bg-white/10 text-white border border-white/30 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-yellow-400 placeholder-gray-300"
                />
              </div>
