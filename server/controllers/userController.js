...
exports.registerUser = async (req, res) => {
  ...
  try {
    ...
    // ✅ Normalize skills via AI before saving
    const normalizedTeach = await normalizeSkills(teach || []);
    const normalizedLearn = await normalizeSkills(learn || []);
    ...
    const user = await User.create({
      ...
      password: hashed,
      teach: teach || [],
      teach_normalized: normalizedTeach,
      learn: learn || [],
      learn_normalized: normalizedLearn,
      avatar: "",
      bio: "",
      social: "",
      isAdmin: false,
...
exports.updateProfile = async (req, res) => {
  try {
    ...
    const { name, email, bio, social, password } = req.body;
